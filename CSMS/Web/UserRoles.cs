...
namespace cloud.charging.open.CSMS.Web
{

    /// <summary>
    /// What somebody signed in to this CSMS is allowed to do.
    /// </summary>
    /// <remarks>
    ...
    ///
    /// Only what this CSMS actually enforces is named here. A
    ...
    /// they guard did: which charging stations may call this CSMS is its
    /// own permission rather than something that grew quietly inside one that
    /// already existed, and so is the trust the CSMS extends.
    /// </remarks>
    [Flags]
    public enum Permissions : UInt32
    {
        ...
        /// <summary>
        /// Generate the keys this CSMS authenticates with, take in
        ...
        /// station server. Everything else here is about what this CSMS
    ...
    /// </summary>
    /// <remarks>
    /// A closed set: a role this CSMS has never heard of is a role
                                  ...
                                  Permissions  Permissions)
    {
        ...
        /// <summary>
        /// May look at this CSMS, and do nothing to it.
        /// </summary>
        ...
        /// estate long before it is reached by whoever installed it, and a name
        /// server that moved is their problem to fix.
        /// </remarks>
                                       ...
                                       [NotNullWhen(false)] out String?    Error)
        {
            ...
            Error  = Role is null
                         ? $"\"{Text}\" is not a role this CSMS knows. Known roles: {String.Join(", ", All.Select(role => role.Name))}."
                         : null;
    ...
    public static class UserRoleExtensions
    {
        ...
        /// </summary>
        /// <remarks>
        /// What the browser is told is a copy of what the CSMS
