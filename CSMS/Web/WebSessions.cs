...
namespace cloud.charging.open.CSMS.Web
{
    ...
    /// is the part a CSMS has of its own: one login rather than an
    ...
    public sealed class WebSessions
    {
        ...
        /// </summary>
        public static readonly HTTPCookieName  DefaultCookieName       = HTTPCookieName.Parse("CSMS");
        ...
        /// </summary>
        /// <remarks>
        /// Asked about the session rather than about the CSMS, although
