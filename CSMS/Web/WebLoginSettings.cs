...
namespace cloud.charging.open.CSMS.Web
{
    ...
    /// <summary>
    /// Who may open the web interface of this CSMS: one username
    /// and one password.
    /// </summary>
    /// <remarks>
    ...
    public sealed record WebLoginSettings
    {
        ...
        /// whoever signs in and not of the CSMS: the day this file holds
        ...
        /// <summary>
        /// Who may open the web interface of this CSMS.
        /// </summary>
        ...
        /// one login a CSMS makes up for itself on a first start belongs to
        ...
        /// <summary>
        /// The username of a login this CSMS made up for a first start.
        /// </summary>
        ...
        /// what the one login of a CSMS used to be, and reading an old file
        /// as something less would lock whoever wrote it out of their own
        /// CSMS. A file with an empty "roles" is refused instead: somebody
