...
namespace cloud.charging.open.CSMS.Logging
{
    ...
    /// <summary>
    /// Everything the libraries below this CSMS write with Illias' DebugX,
    ...
    /// release build shows on the Logs page is what this CSMS logs itself.
    ///
    ...
    /// filtered away. What a CSMS overhears is mostly OCPP going
    /// past it in both directions, so the table leans that way: which side a
    /// line is about - this CSMS or one of the stations connected to it - is
    /// worth more here than which layer it came from.
    /// </remarks>
    public sealed class TraceBridge : TraceListener
    {
        ...
        /// tell what the CSMS said itself from what it overheard.
        /// </summary>
