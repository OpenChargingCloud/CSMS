...
namespace cloud.charging.open.CSMS.Logging
{
    ...
    /// <summary>
    /// Everything that happens inside this CSMS, in one place: the
    ...
    /// actually has in front of a CSMS is "what happened just now",
    ...
    public sealed class EventLog
    {
        ...
        /// somewhere else than the rest of the CSMS is a log that cannot be
        ...
        /// <summary>Something is not as it should be, but the CSMS carries on.</summary>
