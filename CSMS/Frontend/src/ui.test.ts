...
describe('a page while the CSMS is being told', () => {
    ...
    it('comes back when it failed as well, or the page would be dead', async () => {
        ...
        await assert.rejects(() =>
            whileSaving(page(live), note, () => Promise.reject(new Error('the CSMS said no'))));
    ...
    it('hands back what the CSMS answered, untouched', async () => {
