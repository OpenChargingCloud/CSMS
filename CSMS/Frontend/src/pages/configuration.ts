...
/**
 * What this CSMS is made of - read-only: it answers "what am I
 * running", not "change it". What can be changed has a page of its own, and
 * both are reachable from the same menu.
 *
 * The sections are rendered from whatever the CSMS sends rather than
...
export const configurationPage: Page = {
    ...
    render({ root }) {
        ...
        const content = shell(root, {
            ...
            title:     'Configuration',
            subtitle:  'What this CSMS is made of.',
            ...
            try
            {
                ...
                render(content, html`
                    ...
                    <div class="cards">
                        ...
                        ${card('CSMS', 'fa-sitemap', configuration.CSMS, html`
                            <div class="kv">
...
/**
 * One section: every field the CSMS sent, in the order it sent them,
