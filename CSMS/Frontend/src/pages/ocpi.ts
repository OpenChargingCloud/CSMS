 ...
 * how much has travelled - read-only, on purpose.
 *
 * The country code, the party identification and the versions offered are
 * what every partner wrote into its credentials; changing them under a live
 * registration would not rename the operator, it would make it a second one
 * nobody is registered with. So they are read from the configuration file at
 * the start, and this page says where that file is.
 *
        ...
        function draw(ocpi: OCPIConfiguration): void {
            ...
            render(content, html`
                ...
                <div class="cards">
                    ...
                    <section class="card">
                        <h2><i class="fa-solid fa-id-badge"></i> This operator</h2>
                        <div class="kv-list">
                        ...
                        <p class="hint">
                            Read once, at the start, from the <code>ocpi</code> section of ${ocpi.file}. A partner
                            knows this operator by these, so they are not changed while it runs. They have nothing
                            to do with the OCPP identification the charging stations know it by.
                        </p>
                    </section>

                    <section class="card">
                        <h2><i class="fa-solid fa-link"></i> Where partners find it</h2>
                        <div class="kv-list">
                        ...
                        <p class="hint">
                            The versions URL is the one thing a partner is given: everything else is discovered from
                            it. Behind a reverse proxy or a public name, set <code>ocpi.externalURL</code> so that the
                            URLs advertised here are the ones a partner can reach.
                        </p>
                    </section>
                    ...
                    <section class="card">
                        ...
                        <div class="kv-list">
                            ...
                            <div class="kv"><span class="k">Locations</span><span class="v"><a href="/configuration/ocpi/locations">${ocpi.counts.locations}</a></span></div>
                            <div class="kv"><span class="k">Tokens</span><span class="v"><a href="/roaming/tokens">${ocpi.counts.tokens}</a></span></div>
                        ...
                        <p class="hint">
                            Kept by the OCPI library in append-only files below that directory, one set per version,
                    ...
                    <section class="card wide">
                        ...
                        <p class="hint">
                            ...
                            by this operator; a partner needs the token it was given to call any of them.
                        </p>
