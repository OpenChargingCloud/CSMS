 ...
 * made for - but that happens inside the CSMS and takes effect at once, so
...
export const ntsPage: Page = {
    ...
    render({ root }) {
            ...
            render(content, html`
                ...
                <div class="cards">
                    ...
                    <section class="card">
                        ...
                        <p class="hint">
                            Switched off, this CSMS asks its time server nothing at all - the
                        ...
                        <p class="hint">
                            ${mayTest
                                  ? html`
                                      ...
                                      this CSMS is not stepped by it - that is a different thing, with meter
         ...
         *
         * Every word of the verdict comes from the CSMS: whether a time
         ...
         * would sooner or later say "legal" where the CSMS says nothing
         * of the kind.
         */
                ...
                <section class="card">
                    ...
                    <div class="kv-list">
                        ...
                        <div class="kv">
                            ...
                            <span class="v">${formatValue(now.now)} <span class="muted small">(this CSMS's own clock)</span></span>
                        </div>
                    ...
                    <p class="hint">
                        ${now.legal
                              ? html`
                                ...
                                `
                              : html`
                                  Unverified: ${why[now.why ?? ''] ?? 'the CSMS did not say why'}. The
                                  time above is still this CSMS's own clock and is still what everything
