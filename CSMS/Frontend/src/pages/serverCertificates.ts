...
/**
 * The certificates this CSMS presents to the charging stations.
 *
 ...
 * arrives even if it only becomes valid in two days, and the CSMS
...
export const serverCertificatesPage: Page = {
    ...
    render({ root }) {
        ...
        const content = shell(root, {
            ...
            title:     'Server certificates',
            subtitle:  'What this CSMS presents to the charging stations, and what takes over when it runs out.',
            ...
            render(content, html`
                ...
                ${configuration.reachableAs.length > 0 ? '' : html`
                    <div class="notice warn">
                        This CSMS has not been told what it is
                ...
                <div class="cards">
                        ...
                        <form id="create-form" class="form-stack">
                            ...
                            <label>Subject
                                <input type="text" name="subject" maxlength="200"
                                       ...
                                       placeholder="csms001.example.org"
                            ...
                            <div class="notice">
                                ...
                                CSMS finds out by trying, and says so beside the certificate rather than
                    ...
                    <section class="card wide">
                        ...
                        <p class="hint">
                            In ${certificates.directory}. By this CSMS's clock it is
                            ${formatTimestamp(certificates.now)} - which is what decides which of these is in its
                            window, so a CSMS whose clock is wrong presents the wrong one.
                        </p>
