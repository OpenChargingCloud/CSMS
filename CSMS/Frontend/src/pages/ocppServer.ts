 ...
 * it accepts are their own pages - those are about who this CSMS is and
...
export const ocppServerPage: Page = {
    ...
    render({ root }) {
        ...
        const content = shell(root, {
            ...
            title:     'Charging stations',
            subtitle:  'The HTTP WebSocket server the charging stations below this CSMS connect to.',
                ...
                <div class="cards">
                    ...
                    <section class="card">
                        ...
                        <p class="hint">
                            ...
                            CSMS that opens a port to a network rather than reaching out to one, so it
            ...
            return html`
                <section class="card">
                    ...
                    <form id="profiles-form" class="form-stack">
                        ...
                        <span class="hint">
                            Off by default: a CSMS in a car park frequently has no route to the list, and a
