...
//
// A page holding something the CSMS has not been told about is asked about
// before it is left: measured in the charging station's web interface, one
// click on a menu entry threw away an EVSE that had just been added, and
