/**
 * What the web interface does with work the CSMS has not been told about.
 *
 ...
 *
 * What is pinned is what was measured to be wrong, in the charging station's
 * web interface this comes from: an EVSE added to the list and then thrown
 * away by one click on Reload, and the same work thrown away by one click on a
 * menu entry - both without a word.
 */
...
describe('whether a form has been typed into since it was drawn', () => {
    ...
    it('is no, for a form still as the CSMS left it', () => {
