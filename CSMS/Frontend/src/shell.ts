            ...
            <nav class="sidebar" aria-label="Sections">
                ...
                <div class="sidebar-foot">
                    ...
                    <div class="versions small muted">
                        CSMS ${config.serverVersion} &middot; web ${config.frontendVersion}
                    </div>
                </div>
 ...
 * everywhere else, so a CSMS with a dozen pages still fits on the left.
 */
