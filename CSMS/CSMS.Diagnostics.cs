...
namespace cloud.charging.open.CSMS
{
    ...
    public partial class CSMS
    {
        ...
        /// </summary>
        /// <remarks>
        /// The clock of this CSMS is not set from the answer, and
        ...
        /// wants to know. Stepping the clock of a running CSMS is a
        ...
        public async Task<JObject> SyncTimeAsync(CancellationToken CancellationToken = default)
        {
            ...
            try
            {
                ...
                Log.Notice(
                    ...
                    (offset.HasValue ? $", this CSMS's clock is {offset.Value.TotalMilliseconds:+0.0;-0.0;0} ms off" : "") +
