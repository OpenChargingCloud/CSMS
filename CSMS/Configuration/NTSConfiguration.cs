...
namespace cloud.charging.open.CSMS.Configuration
{
    ...
    /// <summary>
    /// The "nts" section of the configuration file: where this CSMS
    ...
    /// missing keeps whatever the CSMS was given at construction.
    /// </remarks>
    /// <param name="Enabled">Whether this CSMS asks a time server at all.</param>
    ...
    /// <param name="CheckEvery">How often this CSMS checks its clock against that server.</param>
    /// <param name="LegalTimeAuthority">Who stands behind that server's time, e.g. "PTB" - the operator saying so, because this CSMS cannot find out by itself.</param>
    /// <param name="LegalTimeTolerance">How far this CSMS's own clock may be from it and still count.</param>
    /// <param name="LegalTimeMaxAge">How old the last check may be and still count.</param>
    /// <param name="Servers">Every time server of this CSMS, or none to ask only the one named by Hostname.</param>
                                          ...
                                          TimeSpan?                             MaxDeviation          = null)
    {
        ...
        /// <summary>
        /// How often this CSMS checks its clock against its time server,
        ...
        /// public time server does not notice this CSMS at all.
        /// </remarks>
        public static readonly TimeSpan  DefaultCheckEvery        = TimeSpan.FromMinutes(15);

        /// <summary>
        /// How far this CSMS's clock may be from the time it was checked
        ...
        /// <summary>
        /// The time server this CSMS asks when nothing says otherwise.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// The time servers this CSMS asks when its configuration names none.
        /// </summary>
        /// <remarks>
        ...
        /// leave this CSMS without a clock, and because two servers that agree
        ...
        /// <summary>
        /// The group a CSMS asks when nothing has said otherwise.
        /// </summary>
        ...
        /// <summary>
        /// The time servers of this CSMS as a group that can be asked.
        /// </summary>
        /// <remarks>
        /// Called "legal" after the white paper's well-known group, because
        /// this is the clock a charge is billed by. A CSMS asking a second
