...
namespace cloud.charging.open.CSMS.Configuration
{
    ...
    /// server the charging stations below this CSMS connect to.
    /// </summary>
    /// <remarks>
    /// As in the DNS and NTS sections, null means "the file does not say": what
    /// is missing keeps whatever the CSMS was given at
    ...
    /// charging stations arrive over the network and never from the loopback
    /// address. A CSMS that started listening for them merely because it was
    /// updated to a version that can would be a port nobody chose to open.
    ///
    ...
    /// may read - see <see cref="CSMSConfigFile"/>. They live beside it
    /// in files of their own, with permissions of their own.
    /// </remarks>
    /// <param name="Enabled">Whether this CSMS listens for charging stations at all.</param>
    ...
    /// <param name="ReachableAs">The names and addresses the charging stations reach this CSMS under - what a certificate has to be valid for.</param>
                                                 ...
                                                 OCPPServerLogging?       Logging                      = null)
    {
        ...
        /// </summary>
        /// <remarks>
        /// Beside the web interface of this CSMS (2351) and not on it: the two
        /// serve different networks, present different certificates and let in
        /// different callers, and a single port would make one set of rules out
        /// of two.
        /// </remarks>
        public static readonly IPPort         DefaultTCPPort             = IPPort.Parse(2352);

        /// <summary>
        /// Which OCPP versions are offered when nothing says otherwise.
        /// </summary>
        /// <remarks>
        /// Not OCPP 1.6: a CSMS that offers it can be talked to by
        ...
        /// issuer this CSMS was told to trust.
        /// </remarks>
        ...
        /// CSMS that refused 1.2 would refuse a good part of what is
        ...
        /// <summary>
        /// How many names this CSMS may be reachable under.
        /// </summary>
                                       ...
                                       [NotNullWhen(false)] out String?                  Error)
        {
            ...
            if (subprotocols is not null)
            {
                ...
                {
                    Error = $"'{SectionName}.subprotocols': '{unknown}' is not an OCPP version this CSMS speaks ({String.Join(", ", KnownSubprotocols)}).";
                    return false;
                }
            ...
            #region The names the charging stations reach this CSMS under
        ...
        /// <summary>
        /// The section as it is written to the file; what this CSMS
