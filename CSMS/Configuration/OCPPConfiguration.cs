...
namespace cloud.charging.open.CSMS.Configuration
{
    ...
    /// <summary>
    /// The "ocpp" section of the configuration file: who this CSMS
    /// says it is when it speaks OCPP.
    /// </summary>
    /// <remarks>
    /// As in the DNS and NTS sections, null means "the file does not say": what
    /// is missing keeps whatever the CSMS was given at construction.
    ///
    ...
    /// this CSMS by and what every charging station below it was told to
    /// address; changing it under a live connection would not rename the
    /// CSMS, it would make it a second one that nobody is talking to.
    /// </remarks>
    /// <param name="NodeId">The networking node identification, e.g. "csms001".</param>
    /// <param name="VendorName">Who made this CSMS.</param>
                                           ...
                                           String?  SoftwareVersion   = null)
    {
        ...
        /// <summary>
        /// What this CSMS calls itself when nothing says otherwise.
        /// </summary>
        public const String  DefaultNodeId          = "csms001";
        ...
        /// </summary>
        public const String  DefaultModel           = "CSMS";
