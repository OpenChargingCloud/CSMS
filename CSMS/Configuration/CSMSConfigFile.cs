...
namespace cloud.charging.open.CSMS.Configuration
{
    ...
    /// <summary>
    /// The configuration of this CSMS, in a file beside it.
    /// </summary>
    /// <remarks>
    /// What a CSMS is - what it is called in OCPP, where it
    ...
    public sealed class CSMSConfigFile
    {
        ...
        /// </summary>
        public CSMSConfigFile(String Path)
        {
        ...
        /// </summary>
        public Boolean TryLoad([NotNullWhen(true)] out CSMSConfiguration?  Configuration,
                                                   out String?                Error)
        {
            ...
            if (!CSMSConfiguration.TryParse(document, out Configuration, out var problem))
            {
                Error = $"'{Path}': {problem}";
                return false;
            }
        ...
        /// </summary>
        /// <remarks>
        /// This is what makes a partial save safe: a CSMS that only
                                       ...
                                       [NotNullWhen(false)] out String?   Error)
        {
            ...
            if (!File.Exists(Path))
            {
                // No file is not a failure, it is a CSMS nobody has
        ...
        /// rather than half of the new one. A CSMS that cannot read
        ...
        /// now - and a file that stops the CSMS is worse than a save that is
        /// refused.
        /// </remarks>
                                ...
                                [NotNullWhen(false)] out String?  Error)
        {
            ...
            try
            {
                ...
                // Move, not copy: on every file system this CSMS runs on
