...
namespace cloud.charging.open.CSMS.OCPP
{
    ...
    /// <summary>
    /// What a charging station's certificate has to lead to before this
    /// CSMS lets it in.
    /// </summary>
    /// <remarks>
    ...
    /// could issue a certificate for a charging station that this CSMS
            ...
            lock (updateLock)
            {
                ...
                if (enabled.Length == 0)
                    return new ClientTrustResult(
                               ...
                               null,
                               Certificate.Subject,
                               "this CSMS has not been told which certificate authorities to accept charging stations from"
                           );
