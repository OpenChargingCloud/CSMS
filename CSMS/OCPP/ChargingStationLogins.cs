...
namespace cloud.charging.open.CSMS.OCPP
{
    ...
    /// <summary>
    /// Which charging stations may sign in to this CSMS, with
    ...
    /// has been set is not readable again, not by this CSMS and not by
    ...
    public sealed class ChargingStationLogins
    {
        ...
        /// station, and a CSMS that accepted "1234" would be the weakest
                                     ...
                                     TimeProvider?  TimeProvider  = null)
        {
            ...
            // Before anything is read, so that a CSMS with no file at all
        ...
        /// <summary>
        /// Read the file. No file is not a failure - it is a CSMS
                                      ...
                                      [NotNullWhen(false)] out String?  Error)
        {
            ...
            lock (updateLock)
            {
                ...
                {
                    Error = $"This CSMS has never heard of a login group called '{Id}'.";
                    return false;
                }
                                   ...
                                   [NotNullWhen(false)] out String?  Error)
        {
            ...
            lock (updateLock)
            {
                ...
                {
                    Error = $"This CSMS has never heard of a charging station called '{Id}'.";
                    return false;
                }

                if (!groups.ContainsKey(groupId))
                {
                    Error = $"This CSMS has never heard of a login group called '{GroupId}'.";
                    return false;
                }
                                      ...
                                      [NotNullWhen(false)] out String?  Error)
        {
            ...
            if (!TryChange(id,
                           ...
                           existed => existed
                                          ...
                                          : $"The charging station '{id}' may now sign in to this CSMS.",
                           out Error))
            {
                Generated = null;
                return false;
        ...
        /// to stay readable for the CSMS to compute tokens from, so it
                                  ...
                                  [NotNullWhen(false)] out String?  Error)
        {
            ...
            if (!TryChange(id,
                           ...
                           existed => existed
                                          ...
                                          : $"The charging station '{id}' may now sign in to this CSMS with a one-time token.",
                           out Error))
            {
                return false;
            }
