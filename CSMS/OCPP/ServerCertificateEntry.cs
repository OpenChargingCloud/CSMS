...
namespace cloud.charging.open.CSMS.OCPP
{
    ...
    public sealed class ServerCertificateEntry : IDisposable
    {
        ...
        /// <summary>
        /// When it was generated, by the clock of this CSMS.
        /// </summary>
        ...
        /// on something other than the certificate: the names this CSMS
        ...
        /// </remarks>
        /// <param name="Now">What time it is, by the clock of this CSMS - which is what decides whether a certificate is in its window.</param>
