...
namespace cloud.charging.open.CSMS.OCPP
{
    ...
    /// <summary>
    /// One charging station that may sign in to this CSMS, and
                                              ...
                                              String?          Note)
    {
        ...
        /// </summary>
        /// <remarks>
        /// A file written before this CSMS had heard of groups holds no
                                       ...
                                       [NotNullWhen(false)] out String?                Error)
        {
            ...
            if (passwordText is not null && passwordText.Length > 0)
            {
                ...
                {
                    Error = $"the password of '{id}' is not a hash this CSMS can read.";
                    return false;
                }
