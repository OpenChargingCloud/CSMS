    ...
    public partial class CSMS
    {
        ...
        public JObject DNSConfigurationJSON()
            ...
            => new (
                   ...
                   // The servers this CSMS would ask, which is not the same
        ...
        /// <summary>
        /// Change how this CSMS resolves names, at once and for everything
                                                 ...
                                                 [NotNullWhen(false)] out String?  Error)
        {
            ...
            {
                Error = "A CSMS that resolves no names cannot reach its time server, nor anything else it is pointed at by name. Switch name resolution off instead of emptying the list.";
                return false;
            }

            // Under the same lock as every other change to this CSMS:
        ...
        private void ApplyDNSConfiguration(DNSConfiguration Configuration)
        {
            ...
            // must end up holding exactly the servers this CSMS means it to
        ...
        /// <summary>
        /// Where this CSMS gets the time from, and how the key exchange
        /// behind it is doing.
        /// </summary>
        /// <remarks>
        ...
        /// "keyExchange" - which read as this CSMS's time server and the
        ...
        public JObject NTSConfigurationJSON()
        {
            ...
            return new JObject(
                       ...
                       // it is in effect. The quorum is the one this CSMS was
                       ...
                       // checks this CSMS's clock: each server's key
        ...
        /// <summary>
        /// Change where this CSMS reads the time.
        /// </summary>
        /// <remarks>
        /// Pointing the CSMS at another server replaces the client rather
                                                 ...
                                                 [NotNullWhen(false)] out String?  Error)
        {
            ...
            try
            {
                ...
                // section the next start refuses, and a CSMS that does not
        ...
        /// </summary>
        /// <remarks>
        /// The end of the chain this CSMS built, not of the one the server sent,
        /// because that is the root the certificate was judged by - and the one
        /// a pinned root would be compared with, by this fingerprint. The name
        /// is the root's common name: "ISRG Root X1" says which root it is,
        /// where its whole subject is mostly the organisation again.
        /// </remarks>
        ...
        private void ApplyNTSConfiguration(NTSConfiguration Configuration)
        {
                ...
                ntp      != ntsClient.NTP_Port)
            {
                ...
                // about the last exchange belongs to a server this CSMS no
                // longer asks.
                lastTimeSync = null;
            ...
            // The clock is checked on a timer set when this CSMS started, so
