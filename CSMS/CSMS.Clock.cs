...
namespace cloud.charging.open.CSMS
{
    ...
    /// <summary>
    /// What time this CSMS thinks it is, and what that is worth.
    /// </summary>
    /// <remarks>
    /// Two different questions, and a CSMS has to keep them apart.
    ...
    /// **this CSMS does not set its clock from the answer**. It measures the
    /// difference and reports it.
    ///
    /// That is deliberate. A CSMS is the clock that the charging
    ...
    /// <c>nts.legalTimeAuthority</c>, and this CSMS then only repeats that
    ...
    /// CSMS that has not checked, and the whole point of not
    ...
    public partial class CSMS
    {
        ...
        /// <summary>
        /// How often this CSMS checks its clock.
        /// </summary>
        ...
        /// <summary>
        /// How far this CSMS's clock may be off and still count.
        /// </summary>
        ...
        /// <summary>
        /// Begin checking this CSMS's clock against its time server.
        /// </summary>
        /// <remarks>
        /// Through the CSMS's own <see cref="TimeProvider"/> rather than a
        ...
        private void StartCheckingTheClock()
        {
            ...
            if (!NTSEnabled)
            {
                Log.Info("The clock of this CSMS is not being checked: NTS is switched off.", "nts", "clock");
                return;
            }
            ...
            Log.Info(
                $"The clock of this CSMS will be checked against {String.Join(", ", asking)} every {TimeCheckEvery.TotalMinutes:F0} minute(s)" +
        ...
        private async Task CheckTheClockAsync()
        {
            ...
            try
            {
                ...
                if (result.Value<Boolean>("ok") != true)
                    Log.Warning(
                        $"The clock of this CSMS could not be checked: {result.Value<String>("error") ?? "no answer"}.",
                        "nts", "clock"
                    );
            ...
            {
                Log.Warning($"The clock of this CSMS could not be checked: {e.Message}", "nts", "clock");
            }
        ...
        public JObject ClockJSON()
        {
            ...
            return new JObject(
                       ...
                       // Said out loud: the number above is this CSMS's own
                       ...
                       // stays for a group of one, which is what a screen can
