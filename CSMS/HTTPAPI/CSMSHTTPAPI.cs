...
namespace cloud.charging.open.CSMS
{
    ...
    public partial class CSMSHTTPAPI : HTTPAPI
    {
        ...
        private async Task<HTTPResponse> PostDNSQuery(HTTPRequest Request)
        {
            ...
            Log.Info($"'{session.UserId}' asked this CSMS to resolve '{name}'.", "dns", "test", "web");
        ...
        private async Task<HTTPResponse> PostNTSSync(HTTPRequest Request)
        {
            ...
            Log.Info($"'{session.UserId}' asked this CSMS to synchronise its time.", "nts", "test", "web");
            ...
            return Task.FromResult(
                       new HTTPResponse.Builder(Request) {
                           ...
                           HTTPSSEWorker   = async (response, stream) => {
                               ...
                               // CSMS shutting down ends the stream. The
        ...
        /// this, a CSMS with one browser on its Logs page never finishes
        /// shutting down.
        ///
