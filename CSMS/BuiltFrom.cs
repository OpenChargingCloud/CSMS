...
namespace cloud.charging.open.CSMS
{
    ...
    /// <summary>
    /// One assembly this CSMS is running, and the commit it was built from
    ...
    /// <summary>
    /// What this CSMS was built from, read from the assemblies themselves.
    /// </summary>
    /// <remarks>
    ...
    /// either: this repository's own start script still collected hashes for
    /// UsersAPI and OpenChargingCloudAPI, neither of which has been a submodule
    /// here for years.
    /// </remarks>
    public static class BuiltFrom
    {
        ...
        public static IEnumerable<LoadedAssembly> Repositories
            ...
            => RepositoriesOf(Assemblies);

        #endregion


        #region (static) RepositoriesOf(Assemblies)

        /// <summary>
        /// One line per repository of the given assemblies - see
        /// <see cref="Repositories"/>, which is this asked of what the process
        /// has loaded.
        /// </summary>
        /// <remarks>
        ...
        public static IEnumerable<LoadedAssembly> RepositoriesOf(IEnumerable<LoadedAssembly> Assemblies)
        ...
        private static IReadOnlyList<LoadedAssembly> Collect()
        {
            ...
            // CSMS does not reference and would otherwise be missing from
            ...
            while (queue.Count > 0)
            {
                ...
                foreach (var reference in assembly.GetReferencedAssemblies())
                {
                    ...
                    // depending on how the CSMS was started.
                    try
                    {
