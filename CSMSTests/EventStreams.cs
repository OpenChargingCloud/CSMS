...
namespace cloud.charging.open.CSMS.Tests
{
    ...
    internal sealed class EventStream : IDisposable
    {
        ...
        #region (static) OpenAndSettle(CSMS, HTTP)
        ...
        /// immediately stopped the CSMS would usually catch the handler
        /// still writing, where a closed socket ends it by itself, and would
        /// therefore pass against a CSMS that cannot shut down at all.
        ///
        ...
        /// </remarks>
        public static async Task<EventStream> OpenAndSettle(CSMS  CSMS,
                                                            HttpClient       HTTP)
        {
