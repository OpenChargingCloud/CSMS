    ...
    public class ServerCertificateTests
    {
        ...
        public void ARequestNamesEverythingThisControllerIsReachedAs()
        {
            ...
            Assert.Multiple(() => {
                ...
                Assert.That(san, Is.Not.Null, "The signing request named nothing this CSMS is reachable as.");

                Assert.That(san!.EnumerateDnsNames(),                                   Is.EquivalentTo(new[] { "csms001.example.org" }));
        ...
        public void ARequestWithoutNamesIsRefused()
        {
            ...
            Assert.That(store.TryCreateKey("csms001", [], null, out _, out _, out var error), Is.False);
        ...
        public void AKeyThisControllerDoesNotGenerateIsRefused()
        {
            ...
            Assert.That(store.TryCreateKey("csms001", ReachableAs, "dsa-512", out _, out _, out var error), Is.False);
        ...
        public void ACertificateForAKeyThatIsNotHereIsRefused()
        {
            ...
            using var foreign = ca.SignFor("csms001.example.org", clock.Now.AddDays(-1), clock.Now.AddYears(1), ClientAuthentication: false);
        ...
        public void ACertificateForOtherNamesIsTakenInAndSaysSo()
        {
            ...
            Assert.That(store.TryCreateKey("csms001.example.org", [ "somewhere.else.example" ], null, out var id, out var csr, out var keyError),
                        Is.True, keyError);
            ...
            Assert.That(warnings.Any(warning => warning.Contains("csms001.example.org")), Is.True,
        ...
        public void AFreshStartWithNothingValidPresentsTheLastToExpire()
        {
            ...
            Assert.Multiple(() => {
                Assert.That(chosen,               Is.Not.Null, "A CSMS that restarted with only expired certificates presented none.");
        ...
        /// <summary>
        /// One broken file must not stop a CSMS that has three others -
