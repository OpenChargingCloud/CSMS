...
namespace cloud.charging.open.CSMS.Tests
{
    ...
    public class ClientTrustTests
    {
        ...
        {
            directory = TestCSMSs.TemporaryDirectory("trust");
        ...
        /// up with a newer kind of key - and a CSMS that could only
        /// admit stations shaped like its own authority would be a CSMS
        /// nobody can migrate.
        /// </remarks>
        [Test]
        [TestCase("ecdsa-p521")]
        ...
        /// <summary>
        /// And the other way round: a CSMS told to trust an authority
