...
namespace cloud.charging.open.CSMS.Tests
{
    ...
    internal sealed class TestCA : IDisposable
    {
        ...
        /// <summary>
        /// The certificate of this authority, which is what a CSMS would
        /// be told to trust.
        /// </summary>
        ...
        /// being tested is what the CSMS asked for and got back, and an
        ...
        /// station, for instance, which does not ask this CSMS for one.
        /// </summary>
