...
namespace cloud.charging.open.CSMS.Tests
{
    ...
    /// <summary>
    /// The one login a CSMS has: how it is made, what it grants,
    ...
    public class WebLoginTests
    {
        ...
        public void MakeADirectory()
            => directory = TestCSMSs.TemporaryDirectory("login");
        ...
        /// <summary>
        /// That is what the one login of a CSMS used to be, and reading
        ...
        /// <summary>
        /// A role this CSMS has never heard of is one it cannot enforce,
        ...
        public void EveryRoleGrantsSomethingAndTheAdminGrantsEverything()
        {
            ...
            Assert.Multiple(() => {
                ...
                Assert.That(UserRole.SystemAdmin.Permissions, Is.EqualTo(everything),
                            "The system administrator does not grant everything this CSMS knows.");
        ...
        public void ARoleIsFoundByItsNameInAnyCase()
        {
            ...
            Assert.Multiple(() => {
                ...
                Assert.That(UserRole.TryParse("installer",   out _, out var error),  Is.False,
                            "A role this CSMS does not have was accepted.");
