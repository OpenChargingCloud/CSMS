...
namespace cloud.charging.open.CSMS.Tests
{
    ...
    /// token, and what this CSMS refuses to store.
    /// </summary>
    public class TOTPSettingsTests
    {
        ...
        /// the way the station makes it rather than the way the CSMS
        /// checks it.
        /// </summary>
        ...
        /// CSMS that stored one anyway would turn that into an exception
        ...
        public void TheSharedSecretIsNotInWhatThePageReads()
        {
            ...
            Assert.Multiple(() => {
                ...
                Assert.That(forTheFile.Value<String>("sharedSecret"), Is.EqualTo(TheSecret),
                            "The file has to carry it: the CSMS computes tokens from it.");
        ...
        /// the CSMS quietly starts expecting tokens no charging station
        /// can produce.
        /// </summary>
        [Test]
