...
namespace cloud.charging.open.CSMS.Tests
{
    ...
    public class LoginGroupTests
    {
        ...
        public void MakeAFile()
        {
            ...
            directory = TestCSMSs.TemporaryDirectory("groups");
        ...
        /// <summary>
        /// A CSMS updated to a version that knows about groups must let
        ...
        /// <summary>
        /// The charging stations of a CSMS that is updated must keep
        /// signing in, and the file of that CSMS says nothing about
        /// groups at all.
        /// </summary>
        [Test]
