...
namespace cloud.charging.open.CSMS.Tests
{
    ...
    public class NTSGroupConfigurationTests
    {
        ...
        {
            directory = TestCSMSs.TemporaryDirectory("nts-group");
        }
        ...
        /// <summary>
        /// Three servers and a quorum of four is a CSMS that can never have
        ...
        public void AListWithoutAQuorumIsHeldToTwo()
        {
            ...
            var section = JObject.Parse("""{ "servers": [ "ptbtime1.ptb.de", "ptbtime2.ptb.de", "ptbtime3.ptb.de", "ptbtime4.ptb.de" ] }""");
        ...
        public void AQuorumNobodyNamedIsNeverMoreThanTheServersSwitchedOn()
        {
            ...
            var section = JObject.Parse("""{ "servers": [ "a.example", { "hostname": "b.example", "enabled": false } ] }""");
        ...
        public void WhatIsWrittenComesBack()
        {
            ...
            Assert.Multiple(() => {
                ...
                // CSMS wrote reads the way somebody would have written it.
