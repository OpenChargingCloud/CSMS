...
namespace cloud.charging.open.CSMS.Tests
{
    ...
    /// </remarks>
    public class StationAuthMethodTests : ACSMSTests
    {
        ...
        /// CSMS, not the test's idea of the format.
        /// </summary>
        ...
        private void GiveATokenTo(String Id, String? Group = null)
        {
            ...
            if (!CSMS.StationLogins.TrySetTOTP(Id, TheSecret, null, null, null, null, Group, null,
                                                     out _, out var error))
            {
        ...
        public async Task TakingThePasswordAwayLeavesTheTokenWorking()
        {
            ...
            Assert.That(CSMS.StationLogins.TryClearPassword("cs001", out var error), Is.True, error);
        ...
        public async Task AGroupThatDoesNotAcceptTokensTurnsOneAway()
        {
            ...
            CSMS.StationLogins.TryAddOrUpdateGroup(
        ...
        public async Task AGroupThatDoesNotAcceptPasswordsTurnsOneAway()
        {
            ...
            CSMS.StationLogins.TrySetPassword("cs001", ThePassword, "tokens-only", null, out _, out _);
        ...
        public async Task AGroupThatIsSwitchedOffTurnsItsMembersAway()
        {
            ...
            CSMS.StationLogins.TrySetPassword("cs001", ThePassword, "field", null, out _, out _);
        ...
        public async Task AGroupThatDoesNotAcceptThisProfileTurnsItsMembersAway()
        {
            ...
            CSMS.StationLogins.TrySetPassword("cs001", ThePassword, "encrypted-only", null, out _, out _);
        ...
        public async Task MovingALoginIntoAnotherGroupTakesEffectOnTheNextConnection()
        {
            ...
            Assert.That(CSMS.StationLogins.TrySetGroup("cs001", "tokens-only", out var error), Is.True, error);
