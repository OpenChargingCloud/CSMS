...
namespace cloud.charging.open.CSMS.Tests
{
    ...
    public class ConfigurationSectionTests
    {
        ...
        #region DNS: an absent field leaves what the CSMS had
        ...
        public void AnOCPPSectionSaysNothingUntilItIsToldSomething()
        {
            ...
            Assert.Multiple(() => {
                ...
                // Which is what lets the CSMS fall back to its own.
        ...
        /// CSMS by, and a space in one is a typing mistake rather than a
        /// name.
        /// </summary>
        [Test]
        ...
        public void AnEmptyDocumentSaysNothingIsConfigured()
        {
            ...
            Assert.That(CSMSConfiguration.TryParse([], out var configuration, out var error), Is.True, error);
