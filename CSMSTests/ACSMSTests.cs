...
namespace cloud.charging.open.CSMS.Tests
{
    ...
    /// <summary>
    /// One CSMS, listening, for the length of one test.
    /// </summary>
    /// <remarks>
    /// A whole CSMS per test rather than one for the fixture, because
    /// half of what is worth testing here changes the CSMS: a test that
    ...
    public abstract class ACSMSTests
    {
        ...
        /// <summary>
        /// The CSMS under test, listening, from SetUp until TearDown.
        /// </summary>
        protected CSMS  CSMS   { get; private set; } = default!;

        /// <summary>
        /// The password this CSMS made up for itself at its first start.
        /// </summary>
        ...
        #region What this CSMS is made of

        /// <summary>
        /// What its configuration file says before it is built.
        /// </summary>
        /// <remarks>
        /// Overridden by a fixture that needs a CSMS with something on
