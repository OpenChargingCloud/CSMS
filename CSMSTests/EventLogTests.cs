...
namespace cloud.charging.open.CSMS.Tests
{
    ...
    /// <summary>
    /// What happened inside this CSMS, as a browser reads it: a
    /// snapshot of what led up to now, and then everything from now on over one
    /// Server-Sent Events stream.
    /// </summary>
    public class EventLogTests : ACSMSTests
    {
        ...
        public async Task TheSnapshotCarriesWhatHappened()
        {
            ...
            CSMS.Log.Notice("A line written by a test.", "test");
        ...
        public async Task ATagFiltersTheLog()
        {
            ...
            CSMS.Log.Notice ("The first of two.",  "marked");
            CSMS.Log.Warning("The second of two.", "marked");
            CSMS.Log.Info   ("Not one of them.",   "elsewhere");
            ...
            Assert.Multiple(() => {
                ...
                // something the CSMS writes to its log.
