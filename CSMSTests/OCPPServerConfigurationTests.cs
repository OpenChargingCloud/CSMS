...
namespace cloud.charging.open.CSMS.Tests
{
    ...
    public class OCPPServerConfigurationTests
    {
        ...
        /// rather than reaching out to one. A CSMS that started listening
        ...
        public void TheWholeSectionComesBackAsItWasWritten()
        {
            ...
            var written = new JObject(
                              ...
                              new JProperty("reachableAs",                 new JArray("csms001.example.org", "10.0.0.1")),
            ...
            Assert.Multiple(() => {
                ...
                Assert.That(configuration.ReachableAs,                 Is.EqualTo(new[] { "csms001.example.org", "10.0.0.1" }));
        ...
        public void AReachableNameHasToBeANameOrAnAddress()
        {
            ...
            Assert.Multiple(() => {
                ...
                Assert.That(Refuse(new JObject(new JProperty("reachableAs", new JArray("the CSMS in the car park")))),
                            Does.Contain("neither an IP address nor a domain name"));

                Assert.That(Parse(new JObject(new JProperty("reachableAs", new JArray("csms001.example.org", "CSMS001.example.org")))).ReachableAs,
                            Is.EqualTo(new[] { "csms001.example.org" }),
        ...
        public void AMergeChangesWhatItMentionsAndNothingElse()
        {
            ...
            Assert.Multiple(() => {
                ...
                Assert.That(after.ReachableAs,          Is.EqualTo(new[] { "csms001.example.org" }));
        ...
        public void ASectionOfTheWrongKindIsRefusedByTheDocument()
        {
            ...
            Assert.Multiple(() => {
                ...
                Assert.That(CSMSConfiguration.TryParse(
        ...
        public void TheDocumentCarriesTheSectionLikeEveryOther()
        {
            ...
            Assert.That(CSMSConfiguration.TryParse(document, out var configuration, out var error), Is.True, error);
